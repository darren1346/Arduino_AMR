...
void loop() {
     ...
     if (currentMillis - previousMillis >= loopTime) {  // start timed loop for everything else
         ...
         areaa.data = (int)scale.get_units(10);
         areab.data = (int)scale2.get_units(10);
         if(areab.data>10000){
          areab.data = 0;
         }
         if(areaa.data>30||areab.data>30){
          areaf.data = 1;  
         }
         else{
          areaf.data = 0;
